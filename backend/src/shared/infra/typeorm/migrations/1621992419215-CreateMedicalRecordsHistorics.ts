...
export default class CreateMedicalRecordsHistorics1621992419215 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKey('medicalRecordHistoric', new TableForeignKey({
